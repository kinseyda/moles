<template>
    <div><div class="purchase-desc" id="cost-container"><h4>Cost</h4><ul>
    <CostBullet v-for="id in Object.keys(purchase.dataObject.cost)" :key="id" :resource="getResource(id)" :cost="purchase.trueCost(id)">
      </CostBullet></ul></div><div class="purchase-desc" id="effect-produce-container">
